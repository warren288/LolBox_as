...
public class HotNewsActivity extends BaseActivity {
	...
	private void requestData() {
		...
		httpGetAndParseList(URLUtil.getURL_HotNews(1), SystemConfig.getIntance().getCommHead(),
					HotNewsBlock.class, new IListener<List<HotNewsBlock>>() {
						...
						public void onCall(List<HotNewsBlock> t) {
							...
							mLvHotNews.setSelection(mNewsBlock.size());
						}
					});
	}
	...
	private void requestMore() {
		...
		httpGetAndParseList(URLUtil.getURL_HotNews(mCount + 1), SystemConfig.getIntance()
					.getCommHead(), HotNewsBlock.class, new IListener<List<HotNewsBlock>>() {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			holder.rlMain.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					BaseKitManager.openNewsDetail(HotNewsActivity.this, strNewsId);
				}
			});
