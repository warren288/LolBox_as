...
//	http://zdl.mbox.duowan.com/phone/heroTop10PlayersNew.php?lolboxAction=toHeroTop10Players&hero=Nunu&timestamp=1433652657824 HTTP/1.1
	 ...
	 * @return
	 */
	public static final String getUrl_HeroPlayerRange(String strHeroEng){
		return String.format(Locale.CHINA, "http://zdl.mbox.duowan.com/phone/heroTop10PlayersNew.php" +
				"?lolboxAction=toHeroTop10Players&hero=%s", strHeroEng);
	}

	/**
	 * 取指定英雄的热门评论
	 * @param strHeroEng
	 * @param strOrder 排序，hot 或 time
	 * @return
	 */
	public static final String getUrl_HeroComment(String strHeroEng, String strOrder){
		return String.format(Locale.CHINA, "http://comment3.duowan.com/index.php?r=phone/index" +
				"&domain=lolbox.duowan.com&url=/heroDetail/%s&order=%s&color=&assest", strHeroEng, strOrder);
	}
